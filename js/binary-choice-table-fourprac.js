var jsPsychBinaryChoiceTableFourPrac = (function (jspsych) {
  "use strict";

  const info = {
    name: "binary-choice-table-fourprac",
    parameters: {
      stimulus: {
   ...
   */
  class BinaryChoiceTableFourPracPlugin {
    constructor(jsPsych) {
  ...
  BinaryChoiceTableFourPracPlugin.info = info;

  return BinaryChoiceTableFourPracPlugin;
})(jsPsychModule);
